...
|---|---|---|---|
| Open-Meteo archive (ERA5T) | 8–15 Sep | values through **15 Sep** (yesterday) | ~1-day lag |
| NASA POWER (MERRA-2) | 1–15 Sep | values through **13 Sep**, `-999.0` for 14/15 | ~3-day lag, `-999` fill |
...
| B | 5.00 m/s | VOID_CONFLICT | 5.22 over, 3.84 under — split never settles |
